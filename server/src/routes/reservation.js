...
router.post('/reservations', auth.simple, async (req, res) => {
  ...
  // const QRCode = await generateQR("https://cdn.dribbble.com/users/1998530/screenshots/4234883/ui-011_still_2x.gif?compress=1&resize=400x300");
  const QRCode = await generateQR(`http://192.168.56.1:3000/checkin/${reservation._id}`);
