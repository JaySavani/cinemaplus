...
export const addReservation = reservation => async dispatch => {
  try {
    ...
    if (response.ok) {
      ...
      dispatch(setAlert('Reservation Created', 'success', 1500));
      return {
        status: 'success',
...
export const updateReservation = (reservation, id) => async dispatch => {
  try {
    ...
    if (response.ok) {
      dispatch(setAlert('Reservation Updated', 'success', 1500));
...
export const removeReservation = id => async dispatch => {
  try {
    ...
    if (response.ok) {
      dispatch(setAlert('Reservation Deleted', 'success', 1500));
