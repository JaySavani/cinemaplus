    ...
    return (
      ...
      <div className={rootClassName}>
        ...
        <form autoComplete="off" noValidate>
          ...
          <div className={classes.field}>
            {/* <DatepickerComponent selectedValue={this.state.releaseDate} onChange={event =>
              this.handleFieldChange('releaseDate', event.target.value)} name="Release Date : " />
          </div>
          <div className={classes.field}>
            <DatepickerComponent selectedValue={this.state.endDate} onChange={event =>
              this.handleFieldChange('endDate', event.target.value)} name="End Date : " /> */}
            {/* <MuiPickersUtilsProvider utils={MomentUtils}>
              <Grid container className={classes.grid} justify="space-around">
                <DatePicker
                  ...
                  onChange={(date) =>
                    this.handleFieldChange('releaseDate', date)}
                  disableOpenOnEnter
            ...
            <DatePicker
              selected={endDate}
              onChange={date =>
                this.handleFieldChange('endDate', date)
              }
              name="endDate"
            />
            {/* <MuiPickersUtilsProvider utils={MomentUtils}>
